...
//  BasicSample
//
//  Created by Nilit Danan on 6/16/20.
...
extension VideoData {
    ...
    static func getYouboraVideos() -> [VideoData] {
        ...
        videos.append(VideoData(title: "KalturaMedia - MediaEntry - Defaults",
                                mediaEntry: mediaEntry))
        
        videos.append(VideoData(title: "KalturaMedia - MediaEntry - autoPlay false",
                                mediaEntry: mediaEntry,
                                player: PlayerData(autoPlay: false,
                                                   pluginConfig: PluginConfig(config: [YouboraPlugin.pluginName: analyticsConfig]))))
        
        videos.append(VideoData(title: "KalturaMedia - MediaEntry - startPosition 10",
                                mediaEntry: mediaEntry,
                                player: PlayerData(pluginConfig: PluginConfig(config: [YouboraPlugin.pluginName: analyticsConfig])),
                                startTime: 10.0))
