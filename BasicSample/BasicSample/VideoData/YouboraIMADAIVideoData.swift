...
extension VideoData {
    ...
    static func getYouboraIMADAIVideos() -> [VideoData] {
        ...
        videos.append(VideoData(title: "IMA DAI VOD Don't StartWithPreroll - Sintel - Free Form Media - startPosition 30",
                                freeFormMedia: FreeFormMedia(id: "sintel",
                                                             contentUrl: "https://cdnapisec.kaltura.com/p/2215841/playManifest/entryId/1_w9zx2eti/format/applehttp/protocol/https/a.m3u8"),
                                player: PlayerData(pluginConfig: PluginConfig(config: [IMADAIPlugin.pluginName: imaDAIConfigVODDontStartWithPreroll, YouboraPlugin.pluginName: analyticsConfig])),
                                startTime: 30.0))
        ...
        freeFormMedia: FreeFormMedia(id: "sintel",
                                     contentUrl: "https://cdnapisec.kaltura.com/p/2215841/playManifest/entryId/1_w9zx2eti/format/applehttp/protocol/https/a.m3u8"),
        player: PlayerData(pluginConfig: PluginConfig(config: [IMADAIPlugin.pluginName: imaDAIConfigError, YouboraPlugin.pluginName: analyticsConfig]))))
